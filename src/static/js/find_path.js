...
function findStartEndConnection(_start, _end, _max_api=3){
  var promise = $.ajax({
    type:"POST",
    url: "http://biothings.io/explorer/path",
...
function findOutputTypeBasedOnInputType(_input){
	var promise = $.ajax({
		type: "POST",
		url: "http://biothings.io/explorer/input",
		data: {input: _input},
		datatype: "json"
	});
	return promise;
...
function findInputTypeBasedOnOutputType(_output){
	var promise = $.ajax({
		type: "POST",
		url: "http://biothings.io/explorer/output",
		data: {output: _output},
		datatype: "json"
	});
	return promise;
...
function findInputOutputBasedOnEndpoint(endpoint_name) {
	var promise = $.ajax({
		type: "POST",
		url: "http://biothings.io/explorer/endpoint",
...
function findOutputBasedOnInputAndPath(input_value, _path, _level) {
	var promise = $.ajax({
		type: "POST",
		url: "http://biothings.io/explorer/findoutput",
