...
class TestFunctionsInAPIRegistryParser(unittest.TestCase):
    ...
    def test_prefix2uri(self):
        ...
        self.assertEqual(registry.prefix2uri('ncbigene'), 'http://identifiers.org/ncbigene/')
        self.assertEqual(registry.prefix2uri('hgnc.symbol'), 'http://identifiers.org/hgnc.symbol/')
    ...
    def test_prefix2semantictype(self):
        ...
        self.assertEqual(registry.prefix2semantictype('chembl.compound'), 'chemical')
    ...
    def test_semantictype2prefix(self):
        ...
        self.assertNotIn('chembl.compound', list(registry.semantictype2prefix('anatomy')))
        self.assertNotIn('chembl', list(registry.semantictype2prefix('anatomy')))
        # given an invalid input, return None
